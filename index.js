...
checkPassword = async (username, plaintextPassword) => {
    ...
    if (globalStore[username]) {
        ...
        if (result) {
            ...
            console.log("welcome, you are logged on")
        }
        else {
            // TODO: Display message for invalid credentials
            console.log('uh oh, Looks like that username or password is invalid.')
        }
    }
    else {
...
hashPassword = async (username, password) => {
    ...
    console.log(`'${username} was added. their hash is ${pwHash}'`)
}
